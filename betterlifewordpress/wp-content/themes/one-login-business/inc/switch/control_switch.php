 ...
 * Control - Switch.
 *
 * @package One Login Business
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class One_Login_Business_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'one-login-business-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'one-login-business-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
