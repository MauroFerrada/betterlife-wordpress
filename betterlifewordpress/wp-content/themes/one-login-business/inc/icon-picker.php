...
class One_Login_Business_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'one-login-business' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $one_login_business_font_awesome_icon_array = one_login_business_font_awesome_icon_array();
                    foreach ($one_login_business_font_awesome_icon_array as $one_login_business_font_awesome_icon) {
                            $icon_class = $this->value() == $one_login_business_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($one_login_business_font_awesome_icon).'"></i>
                            <span class="one-login-business-social-class">'.esc_attr($one_login_business_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function one_login_business_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'one-login-business-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'one_login_business_customizer_script' );

if(!function_exists('one_login_business_font_awesome_icon_array')){
    function one_login_business_font_awesome_icon_array(){
