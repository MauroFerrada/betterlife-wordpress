...
= 3.3 =
	...
	-- Added Setting for opening social icon link in a new tab.
	-- Customizer headings Added.
	-- Updated Toggle Settings.
	-- Edited JS in  custom.js.
	-- Added slider content alignment setting.
	-- Added menu text tranformation setting.
	-- Added scroltop alignment setting.

= 3.4 =
	-- Updated tagline show/hide option conditions.
...
= 3.6 =
	...
	-- Updated wordpress.
	-- Updated slider excerpt function.

= 3.7 =
	-- Updated social icon code.
	-- Updated escaping function
	-- Updated theme button settings
