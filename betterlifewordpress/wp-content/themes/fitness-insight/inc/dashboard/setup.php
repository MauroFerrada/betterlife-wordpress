...
<div class="theme-offer">
  ...
  if(isset($_GET['import-demo'])){
    ...
    set_theme_mod('fitness_insight_service_increament','4');

    $service_icon = array('fas fa-dumbbell','fas fa-person-walking','fas fa-person-praying','fas fa-person-skating');

    $service_title = array('Gym','Yoga','Aerobics','Zumba');
    ...
    for($i=1;$i<=4;$i++){
      ...
      set_theme_mod( 'fitness_insight_mid_section_icon'.$i, $service_icon[$i-1]);

    }

  } ?>
    
  <p class="note"><?php esc_html_e("If your website is already live and containing data, please make a backup.This importer will override the Fitness Insight's new customizable values.",'fitness-insight'); ?></p>
