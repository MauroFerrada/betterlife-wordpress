...
function fitness_insight_gettingstarted() {
	add_theme_page( esc_html__('Begin Installation', 'fitness-insight'), esc_html__('Begin Installation', 'fitness-insight'), 'edit_theme_options', 'fitness-insight-guide-page', 'fitness_insight_guide');
}
...
define('FITNESS_INSIGHT_LIVE_DEMO',__('https://trial.ovationthemes.com/fitness-insight/','fitness-insight'));
}
if ( ! defined( 'FITNESS_INSIGHT_BUY_PRO' ) ) {
define('FITNESS_INSIGHT_BUY_PRO',__('https://www.ovationthemes.com/products/fitness-wordpress-theme','fitness-insight'));
}
if ( ! defined( 'FITNESS_INSIGHT_PRO_DOC' ) ) {
define('FITNESS_INSIGHT_PRO_DOC',__('https://trial.ovationthemes.com/docs/ot-fitness-insight-pro/','fitness-insight'));
}
if ( ! defined( 'FITNESS_INSIGHT_FREE_DOC' ) ) {
define('FITNESS_INSIGHT_FREE_DOC',__('https://trial.ovationthemes.com/docs/ot-fitness-insight-free-doc/','fitness-insight'));
}
...
function fitness_insight_guide() {
	...
	<div class="getting-started__header">
		<div class="col-md-10">
			<h2><?php echo esc_html( $fitness_insight_theme ); ?></h2>
			<p><?php esc_html_e('Version: ', 'fitness-insight'); ?><?php echo esc_html($fitness_insight_theme['Version']);?></p>
		</div>
		<div class="col-md-2">
			<div class="btn_box">
				<a class="button-primary" href="<?php echo esc_url( FITNESS_INSIGHT_FREE_DOC ); ?>" target="_blank"><?php esc_html_e('Theme Documentation', 'fitness-insight'); ?></a>
	...
	<div class="import-box">
		<div class="container">
			<h2><?php esc_html_e( 'DEMO IMPORT', 'fitness-insight' ); ?></h2>
			<p><?php esc_html_e('To import all of the demo content, click the Begin With Demo Import button.','fitness-insight'); ?></p>
	...
	<div class="wrap getting-started">
		<div class="container">
			...
			<div class="col-md-3">
				...
				<img class="fitness_insight_img_responsive" style="width: 100%;" src="<?php echo esc_url( $fitness_insight_theme->get_screenshot() ); ?>" />
				<div class="pro-links">
					<hr>
