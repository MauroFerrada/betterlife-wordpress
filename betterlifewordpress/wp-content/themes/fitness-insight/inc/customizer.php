...
function fitness_insight_customize_register( $wp_customize ) {
	...
	if ( $wp_customize->get_section( 'colors' ) ) {
        $wp_customize->get_section( 'colors' )->title = __( 'Global Colors', 'fitness-insight' );
        $wp_customize->get_section( 'colors' )->priority = 2;
    }

    $wp_customize->add_setting( 'fitness_insight_global_color_heading', array(
		'default'           => '',
		'transport'         => 'refresh',
		'sanitize_callback' => 'sanitize_text_field',
	) );
	$wp_customize->add_control( new Fitness_Insight_Customizer_Customcontrol_Section_Heading( $wp_customize, 'fitness_insight_global_color_heading', array(
			'label'       => esc_html__( 'Global Colors', 'fitness-insight' ),
			'section'     => 'colors',
			'settings'    => 'fitness_insight_global_color_heading',
			'priority'       => 1,

	) ) );

    $wp_customize->add_setting('fitness_insight_primary_color', array(
	    'default' => '#fe7d15',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_insight_primary_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Color', 'fitness-insight'),
	 
	)));

	$wp_customize->add_setting('fitness_insight_second_color', array(
	    'default' => '#fd5e48',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_insight_second_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Second Color', 'fitness-insight'),
	 
	)));

	$wp_customize->add_setting('fitness_insight_third_color', array(
	    'default' => '#f2bb1e',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_insight_third_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Third Color', 'fitness-insight'),
	 
	)));

	$wp_customize->add_setting('fitness_insight_heading_color', array(
	    'default' => '#2c2c2c',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_insight_heading_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Heading Color', 'fitness-insight'),
	 
	)));

	$wp_customize->add_setting('fitness_insight_text_color', array(
	    'default' => '#666c6e',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_insight_text_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Text Color', 'fitness-insight'),
	 
	)));

	$wp_customize->add_setting('fitness_insight_primary_fade', array(
	    'default' => '#f5e3b2',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_insight_primary_fade', array(
	    'section' => 'colors',
	    'label' => esc_html__('theme Color Light', 'fitness-insight'),
	 
	)));

	$wp_customize->add_setting('fitness_insight_footer_bg', array(
	    'default' => '#2c2c2c',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_insight_footer_bg', array(
	    'section' => 'colors',
	    'label' => esc_html__('Footer Bg color', 'fitness-insight'),
	)));

	$wp_customize->add_setting('fitness_insight_post_bg', array(
	    'default' => '#ffffff',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_insight_post_bg', array(
	    'section' => 'colors',
	    'label' => esc_html__('White Bg color', 'fitness-insight'),
	)));
	...
	$wp_customize->add_setting( 'fitness_insight_section_cursor_heading', array(
		'default'           => '',
		'transport'         => 'refresh',
		'sanitize_callback' => 'sanitize_text_field',
	) );
	$wp_customize->add_control( new Fitness_Insight_Customizer_Customcontrol_Section_Heading( $wp_customize, 'fitness_insight_section_cursor_heading', array(
		'label'       => esc_html__( 'Cursor Setting', 'fitness-insight' ),
		'section'     => 'fitness_insight_theme_settings',
		'settings'    => 'fitness_insight_section_cursor_heading',
	) ) );
	...
	$wp_customize->add_setting( 'fitness_insight_section_animation_heading', array(
		'default'           => '',
		'transport'         => 'refresh',
		'sanitize_callback' => 'sanitize_text_field',
	) );
	$wp_customize->add_control( new Fitness_Insight_Customizer_Customcontrol_Section_Heading( $wp_customize, 'fitness_insight_section_animation_heading', array(
		'label'       => esc_html__( 'Animation Setting', 'fitness-insight' ),
		'section'     => 'fitness_insight_theme_settings',
		'settings'    => 'fitness_insight_section_animation_heading',
	) ) );

	$wp_customize->add_setting(
		'fitness_insight_animation_enable',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		new Fitness_Insight_Customizer_Customcontrol_Switch(
			...
			'fitness_insight_animation_enable',
			array(
				'settings'        => 'fitness_insight_animation_enable',
				'section'         => 'fitness_insight_theme_settings',
				'label'           => __( 'show/Hide Animation', 'fitness-insight' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'fitness-insight' ),
					'off'    => __( 'Off', 'fitness-insight' ),
				),
	...
	$wp_customize->add_setting('fitness_insight_sticky_icon',array(
		'default'	=> 'fas fa-thumb-tack',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Fitness_Insight_Fontawesome_Icon_Chooser(
        $wp_customize,'fitness_insight_sticky_icon',array(
		'label'	=> __('Sticky Post Icon','fitness-insight'),
		'transport' => 'refresh',
		'section'	=> 'fitness_insight_archieve_post_layot',
		'setting'	=> 'fitness_insight_sticky_icon',
		'type'		=> 'icon'
	)));
	...
	// woocommerce
	if ( class_exists( 'WooCommerce' ) ) { 
		$wp_customize->add_section('fitness_insight_woocoomerce_section',array(
	        'title' => __('Custom Woocommerce Settings', 'fitness-insight'),
	        'panel' => 'woocommerce',
	        'priority' => 4,
	    ) );
...
define('FITNESS_INSIGHT_PRO_LINK',__('https://www.ovationthemes.com/products/fitness-wordpress-theme','fitness-insight'));
