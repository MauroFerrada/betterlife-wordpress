				...
				<div class="row">
					<div class="col-lg-9 col-sm-8 align-self-center">
						<?php if( get_theme_mod('fitness_insight_call_text') != '' || get_theme_mod('fitness_insight_call') != ''){ ?>
							<span class="me-3"><i class="<?php echo esc_attr(get_theme_mod('fitness_insight_call_icon','')); ?> me-2"></i><strong><?php echo esc_html(get_theme_mod('fitness_insight_call_text','')); ?></strong>: <?php echo esc_html(get_theme_mod('fitness_insight_call','')); ?></span>
						<?php }?>
						<?php if( get_theme_mod('fitness_insight_email_text') != '' || get_theme_mod('fitness_insight_email') != ''){ ?>
							<span><i class="<?php echo esc_attr(get_theme_mod('fitness_insight_email_icon','')); ?> me-2"></i><strong><?php echo esc_html(get_theme_mod('fitness_insight_email_text','')); ?></strong>: <?php echo esc_html(get_theme_mod('fitness_insight_email','')); ?></span>
						<?php }?>
					</div>
		...
		<div class="wrap_figure py-3 wow slideInUp">
			<div class="fixed_header">
				<div class="container">
					...
					<div class="col-lg-9 col-sm-6 align-self-center">
