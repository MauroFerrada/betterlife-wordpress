...
if ( ! function_exists( 'fitness_life_coach_enqueue_styles' ) ) :
    ...
    wp_enqueue_script( 'fitness-life-coach-color.js', get_theme_file_uri( '/assets/js/color.js' ), array( 'jquery' ), true );
...
function fitness_life_coach_customize_register() {
	...
	$wp_customize->remove_setting('fitness_insight_primary_color');
	$wp_customize->remove_control('fitness_insight_primary_color');

	$wp_customize->remove_setting('fitness_insight_second_color');
	$wp_customize->remove_control('fitness_insight_second_color');

	$wp_customize->remove_setting('fitness_insight_third_color');
	$wp_customize->remove_control('fitness_insight_third_color');

	$wp_customize->remove_setting('fitness_insight_heading_color');
	$wp_customize->remove_control('fitness_insight_heading_color');

	$wp_customize->remove_setting('fitness_insight_text_color');
	$wp_customize->remove_control('fitness_insight_text_color');

	$wp_customize->remove_setting('fitness_insight_primary_fade');
	$wp_customize->remove_control('fitness_insight_primary_fade');

	$wp_customize->remove_setting('fitness_insight_footer_bg');
	$wp_customize->remove_control('fitness_insight_footer_bg');
...
function fitness_life_coach_customize( $wp_customize ) {
	...
	$wp_customize->add_setting('fitness_life_coach_primary_color', array(
	    'default' => '#fc3c2a',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_life_coach_primary_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Color', 'fitness-life-coach'),
	 
	)));

	$wp_customize->add_setting('fitness_life_coach_second_color', array(
	    'default' => '#fd7669',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_life_coach_second_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Second Color', 'fitness-life-coach'),
	 
	)));

	$wp_customize->add_setting('fitness_life_coach_heading_color', array(
	    'default' => '#000',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_life_coach_heading_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Heading Color', 'fitness-life-coach'),
	 
	)));

	$wp_customize->add_setting('fitness_life_coach_text_color', array(
	    'default' => '#8a8a8a',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_life_coach_text_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Text Color', 'fitness-life-coach'),
	 
	)));

	$wp_customize->add_setting('fitness_life_coach_primary_fade', array(
	    'default' => '#ffe7e5',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_life_coach_primary_fade', array(
	    'section' => 'colors',
	    'label' => esc_html__('theme Color Light', 'fitness-life-coach'),
	 
	)));

	$wp_customize->add_setting('fitness_life_coach_footer_bg', array(
	    'default' => '#000',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fitness_life_coach_footer_bg', array(
	    'section' => 'colors',
	    'label' => esc_html__('Footer Bg color', 'fitness-life-coach'),
	)));
}
...
function fitness_life_coach_copyright_link() {
    $fitness_life_coach_footer_text = get_theme_mod('fitness_insight_footer_text', esc_html__('Life Coach WordPress Theme', 'fitness-life-coach'));
    $fitness_life_coach_credit_link = esc_url('https://www.ovationthemes.com/products/free-life-coach-wordpress-theme');

    echo '<a href="' . $fitness_life_coach_credit_link . '" target="_blank">' . esc_html($fitness_life_coach_footer_text) . '<span class="footer-copyright">' . esc_html__(' By Ovation Themes', 'fitness-life-coach') . '</span></a>';
}

define('FITNESS_LIFE_COACH_PRO_LINK',__('https://www.ovationthemes.com/products/fitness-coach-wordpress-theme','fitness-life-coach'));
...
define('FITNESS_INSIGHT_LIVE_DEMO',__('https://trial.ovationthemes.com/fitness-life-coach/','fitness-life-coach'));
}
if ( ! defined( 'FITNESS_INSIGHT_BUY_PRO' ) ) {
define('FITNESS_INSIGHT_BUY_PRO',__('https://www.ovationthemes.com/products/fitness-coach-wordpress-theme','fitness-life-coach'));
}
if ( ! defined( 'FITNESS_INSIGHT_PRO_DOC' ) ) {
define('FITNESS_INSIGHT_PRO_DOC',__('https://trial.ovationthemes.com/docs/ot-fitness-life-coach-pro-doc/','fitness-life-coach'));
}
if ( ! defined( 'FITNESS_INSIGHT_FREE_DOC' ) ) {
define('FITNESS_INSIGHT_FREE_DOC',__('https://trial.ovationthemes.com/docs/ot-fitness-life-coach-free-doc/','fitness-life-coach'));
}
